...
public class EmailServiceImpl implements EmailService {
    ...
    private String buildConfirmationHtml(CommandeDTO cmd) {
        ...
        sb.append("<td style=\"text-align:center;width:25%;padding:0;\"><div style=\"display:inline-block;width:36px;height:36px;border-radius:50%;background:linear-gradient(135deg,#1a73e8,#1557b0);color:#fff;font-size:14px;font-weight:700;line-height:36px;text-align:center;\">1</div><p style=\"margin:6px 0 0;font-size:10px;font-weight:600;color:#1a73e8;text-transform:uppercase;letter-spacing:0.5px;\">Confirm&#233;e</p></td>");
        sb.append("<td style=\"text-align:center;width:25%;padding:0;\"><div style=\"display:inline-block;width:36px;height:36px;border-radius:50%;background:#e8f0fe;color:#9aa0a6;font-size:14px;font-weight:700;line-height:36px;text-align:center;\">2</div><p style=\"margin:6px 0 0;font-size:10px;font-weight:600;color:#9aa0a6;text-transform:uppercase;letter-spacing:0.5px;\">Pr&#233;paration</p></td>");
        sb.append("<td style=\"text-align:center;width:25%;padding:0;\"><div style=\"display:inline-block;width:36px;height:36px;border-radius:50%;background:#e8f0fe;color:#9aa0a6;font-size:14px;font-weight:700;line-height:36px;text-align:center;\">3</div><p style=\"margin:6px 0 0;font-size:10px;font-weight:600;color:#9aa0a6;text-transform:uppercase;letter-spacing:0.5px;\">Exp&#233;di&#233;e</p></td>");
        sb.append("<td style=\"text-align:center;width:25%;padding:0;\"><div style=\"display:inline-block;width:36px;height:36px;border-radius:50%;background:#e8f0fe;color:#9aa0a6;font-size:14px;font-weight:700;line-height:36px;text-align:center;\">4</div><p style=\"margin:6px 0 0;font-size:10px;font-weight:600;color:#9aa0a6;text-transform:uppercase;letter-spacing:0.5px;\">Livr&#233;e</p></td>");
        ...
        sb.append("<table style=\"width:100%;border-collapse:collapse;\"><tr><td style=\"vertical-align:top;width:42px;\">");
        ...
        sb.append("<table style=\"width:100%;border-collapse:collapse;\"><tr>");
        sb.append("<td style=\"text-align:center;width:33%;padding:0 4px;vertical-align:top;\"><div style=\"font-size:22px;margin-bottom:6px;\">&#128274;</div><p style=\"margin:0;font-size:10px;font-weight:600;color:#5f6368;text-transform:uppercase;letter-spacing:0.5px;\">Paiement<br>s&#233;curis&#233;</p></td>");
        sb.append("<td style=\"text-align:center;width:33%;padding:0 4px;vertical-align:top;\"><div style=\"font-size:22px;margin-bottom:6px;\">&#128230;</div><p style=\"margin:0;font-size:10px;font-weight:600;color:#5f6368;text-transform:uppercase;letter-spacing:0.5px;\">Livraison<br>rapide</p></td>");
        sb.append("<td style=\"text-align:center;width:33%;padding:0 4px;vertical-align:top;\"><div style=\"font-size:22px;margin-bottom:6px;\">&#9989;</div><p style=\"margin:0;font-size:10px;font-weight:600;color:#5f6368;text-transform:uppercase;letter-spacing:0.5px;\">Qualit&#233;<br>certifi&#233;e</p></td>");
        sb.append("</tr></table></div>");
    ...
    private String buildStatutChangeHtml(CommandeDTO cmd, StatutCommande ancienStatut) {
        ...
        sb.append("<div style=\"display:inline-block;vertical-align:middle;\"><div style=\"background:#fce8e6;padding:10px 20px;border-radius:12px;\"><span style=\"font-size:12px;color:#9aa0a6;text-decoration:line-through;font-weight:500;\">").append(getStatutLabel(ancienStatut)).append("</span></div></div>");
        sb.append("<div style=\"display:inline-block;vertical-align:middle;margin:0 16px;\"><div style=\"width:48px;height:2px;background:linear-gradient(90deg,#dadce0,").append(getStatutTextColor(cmd.getStatut())).append(");display:inline-block;vertical-align:middle;\"></div><span style=\"font-size:18px;vertical-align:middle;margin-left:4px;\">&#9654;</span></div>");
        sb.append("<div style=\"display:inline-block;vertical-align:middle;\"><div style=\"background:").append(getStatutBgLight(cmd.getStatut())).append(";padding:10px 20px;border-radius:12px;border:2px solid ").append(getStatutTextColor(cmd.getStatut())).append(";\"><span style=\"font-size:14px;color:").append(getStatutTextColor(cmd.getStatut())).append(";font-weight:800;\">").append(getStatutLabel(cmd.getStatut())).append("</span></div></div>");
        sb.append("</div>");
    ...
    private String buildAdminNotificationHtml(CommandeDTO cmd) {
        ...
        sb.append("<table style=\"width:100%;border-collapse:collapse;\"><tr>");
        sb.append("<td style=\"text-align:center;width:33%;padding:4px;\"><span style=\"font-size:20px;font-weight:900;color:#d93025;\">").append(cmd.getMontantTotal()).append("</span><br><span style=\"font-size:10px;color:#80868b;text-transform:uppercase;letter-spacing:0.5px;font-weight:600;\">TND Total</span></td>");
        sb.append("<td style=\"text-align:center;width:33%;padding:4px;border-left:1px solid #e8eaed;border-right:1px solid #e8eaed;\"><span style=\"font-size:20px;font-weight:900;color:#e65100;\">").append(cmd.getNombreArticles()).append("</span><br><span style=\"font-size:10px;color:#80868b;text-transform:uppercase;letter-spacing:0.5px;font-weight:600;\">Articles</span></td>");
        sb.append("<td style=\"text-align:center;width:33%;padding:4px;\"><span style=\"font-size:20px;font-weight:900;color:#ef6c00;\">&#9200;</span><br><span style=\"font-size:10px;color:#80868b;text-transform:uppercase;letter-spacing:0.5px;font-weight:600;\">En attente</span></td>");
        sb.append("</tr></table></div>");
        ...
        sb.append("<table style=\"width:100%;border-collapse:collapse;\">");
        sb.append("<tr><td style=\"padding:8px 0;vertical-align:middle;width:36px;\"><div style=\"width:30px;height:30px;border-radius:8px;background:#e8f0fe;text-align:center;line-height:30px;font-size:13px;\">&#128100;</div></td><td style=\"padding:8px 0 8px 12px;vertical-align:middle;\"><span style=\"font-size:11px;color:#9aa0a6;display:block;\">Nom complet</span><span style=\"font-size:14px;font-weight:700;color:#202124;\">").append(escHtml(cmd.getNomClient())).append("</span></td></tr>");
        sb.append("<tr><td style=\"padding:8px 0;vertical-align:middle;\"><div style=\"width:30px;height:30px;border-radius:8px;background:#e8f0fe;text-align:center;line-height:30px;font-size:13px;\">&#9993;</div></td><td style=\"padding:8px 0 8px 12px;vertical-align:middle;\"><span style=\"font-size:11px;color:#9aa0a6;display:block;\">Email</span><a href=\"mailto:").append(escHtml(cmd.getEmailClient())).append("\" style=\"font-size:14px;font-weight:600;color:#1a73e8;text-decoration:none;\">").append(escHtml(cmd.getEmailClient())).append("</a></td></tr>");
        sb.append("<tr><td style=\"padding:8px 0;vertical-align:middle;\"><div style=\"width:30px;height:30px;border-radius:8px;background:#e8f0fe;text-align:center;line-height:30px;font-size:13px;\">&#128222;</div></td><td style=\"padding:8px 0 8px 12px;vertical-align:middle;\"><span style=\"font-size:11px;color:#9aa0a6;display:block;\">T&#233;l&#233;phone</span><span style=\"font-size:14px;font-weight:600;color:#202124;\">").append(escHtml(cmd.getTelephoneClient())).append("</span></td></tr>");
        sb.append("<tr><td style=\"padding:8px 0;vertical-align:middle;\"><div style=\"width:30px;height:30px;border-radius:8px;background:#e8f0fe;text-align:center;line-height:30px;font-size:13px;\">&#128205;</div></td><td style=\"padding:8px 0 8px 12px;vertical-align:middle;\"><span style=\"font-size:11px;color:#9aa0a6;display:block;\">Adresse livraison</span><span style=\"font-size:14px;font-weight:600;color:#202124;\">").append(escHtml(cmd.getAdresseLivraison())).append("</span></td></tr>");
        if (cmd.getDateCommande() != null) {
            sb.append("<tr><td style=\"padding:8px 0;vertical-align:middle;\"><div style=\"width:30px;height:30px;border-radius:8px;background:#e8f0fe;text-align:center;line-height:30px;font-size:13px;\">&#128197;</div></td><td style=\"padding:8px 0 8px 12px;vertical-align:middle;\"><span style=\"font-size:11px;color:#9aa0a6;display:block;\">Date de commande</span><span style=\"font-size:14px;font-weight:600;color:#202124;\">").append(cmd.getDateCommande().format(DATE_FMT)).append("</span></td></tr>");
        }
        sb.append("</table></div>");
        ...
        if (cmd.getLignes() != null) {
            for (int i = 0; i < cmd.getLignes().size(); i++) {
                ...
                sb.append("<div style=\"display:table-cell;vertical-align:middle;width:65%;\"><p style=\"margin:0;font-size:14px;font-weight:600;color:#202124;\">").append(escHtml(ligne.getNomProduit())).append("</p><p style=\"margin:2px 0 0;font-size:12px;color:#80868b;\">").append(ligne.getQuantite()).append(" &times; ").append(ligne.getPrixUnitaire()).append(" TND</p></div>");
                sb.append("<div style=\"display:table-cell;vertical-align:middle;text-align:right;\"><span style=\"font-size:15px;font-weight:800;color:#d93025;\">").append(ligne.getSousTotal()).append(" TND</span></div>");
                sb.append("</div>");
            }
        }
        sb.append("</div>");
        ...
        sb.append("<div style=\"display:table-cell;vertical-align:middle;\"><span style=\"font-size:14px;color:rgba(255,255,255,0.8);font-weight:500;\">Total &#224; encaisser</span><br><span style=\"font-size:11px;color:rgba(255,255,255,0.6);\">R&#233;f: ").append(escHtml(cmd.getReference())).append("</span></div>");
        sb.append("<div style=\"display:table-cell;text-align:right;vertical-align:middle;\"><span style=\"font-size:28px;font-weight:900;color:#ffffff;letter-spacing:-0.5px;\">").append(cmd.getMontantTotal()).append("</span><span style=\"font-size:14px;color:rgba(255,255,255,0.85);font-weight:600;\"> TND</span></div>");
        sb.append("</div>");
