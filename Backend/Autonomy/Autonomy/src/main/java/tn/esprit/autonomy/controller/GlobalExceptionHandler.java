...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, String>> handleBadRequest(HttpMessageNotReadableException ex) {
        String msg = ex.getMessage() != null ? ex.getMessage() : "JSON invalide ou champ incorrect (trend, scores, etc.)";
    ...
    public ResponseEntity<Map<String, String>> handleOther(Exception ex) {
        ...
        return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR).body(Map.of("error", msg != null ? msg : "Erreur serveur"));
    }
}
