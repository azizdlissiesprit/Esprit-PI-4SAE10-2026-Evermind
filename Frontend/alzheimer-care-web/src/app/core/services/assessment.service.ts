...
import { Assessment, Patient, ChartDataPoint, DomainScore, AssessmentApiResponse } from '../models/assessment.models';
import { COGNITIVE_ASSESSMENT_API_BASE } from '../api.config';
