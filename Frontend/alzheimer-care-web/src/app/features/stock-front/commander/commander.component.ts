    ...
    <div class="fo-section">
      <div class="fo-section-container fade-in">
        ...
        <div class="fo-breadcrumb">
          ...
          <span>/</span>
          <a routerLink="/app/store/panier">Mon Panier</a>
          <span>/</span>
          ...
          <div class="row g-4">
            ...
            <div class="col-lg-7">
              <div class="card">
                <div
                  class="card-header"
                  style="background: linear-gradient(135deg, #1a73e8, #1557b0); color: white;"
                >
                  ...
                  <form #formulaire="ngForm" (ngSubmit)="passerCommande()">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-6 mb-3">
                        ...
                        <div
                          *ngIf="tel.errors?.['pattern'] && tel.touched"
                          class="invalid-feedback"
                        >
                    ...
                    <div class="mb-4">
                      <label for="adresse" class="form-label"
                        >Adresse de livraison <span class="text-danger">*</span></label
                      >
                      <textarea
                        class="form-control"
                        id="adresse"
                    ...
                    <div class="d-flex justify-content-between">
                      <a routerLink="/app/store/panier" class="btn btn-secondary">
              ...
              <div class="card" style="position: sticky; top: 80px;">
                <div class="card-header">
                  <h6 class="mb-0 fw-bold">
                    <i class="bi bi-receipt me-2 text-primary"></i>Récapitulatif de commande
                  </h6>
                </div>
                <div class="card-body p-0">
                  ...
                  >
                    ...
                    <span class="fw-bold" style="font-size: 0.88rem;"
                      >{{ ligne.sousTotal | number: '1.2-2' }} TND</span
                    >
                  </div>
                </div>
  ...
  passerCommande(): void {
    ...
    this.commandeService.creerCommande(this.commande).subscribe({
      next: (commande) => {
        ...
        this.router.navigate(['/app/store/commande', commande.reference], extras);
      },
      error: (err) => {
        this.enCours = false;
