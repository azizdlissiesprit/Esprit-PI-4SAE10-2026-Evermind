              ...
              <form #formulaire="ngForm" (ngSubmit)="sauvegarder()">
                ...
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" id="nom" name="nom"
                         ...
                         #nom="ngModel" title="Ex: Médicaments, Équipements..."
                ...
                <div class="mb-4">
                  ...
                  <textarea class="form-control" id="description" name="description"
                            ...
                            title="Décrivez la catégorie..."></textarea>
                  <small class="text-muted mt-1 d-block">{{ categorie.description.length || 0 }}/500 caractères</small>
                </div>

                <div class="d-flex justify-content-between">
                  <a routerLink="/admin/stock/categories" class="btn btn-secondary">
  ...
  sauvegarder(): void {
    ...
    if (this.estModification && this.categorieId) {
      this.categorieService.modifier(this.categorieId, this.categorie).subscribe({
        next: () => this.router.navigate(['/admin/stock/categories']),
        error: (err) => {
          this.enCours = false;
