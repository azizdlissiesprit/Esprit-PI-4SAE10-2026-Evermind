    ...
    <div class="fade-in">
      <div class="page-header d-flex justify-content-between align-items-center">
        <div>
          ...
          <p class="page-subtitle">{{ categoriesFiltrees.length }} {{ categoriesFiltrees.length !== 1 ? 'catégories' : 'catégorie' }} au total</p>
        </div>
        <a routerLink="/admin/stock/categories/ajouter" class="btn btn-primary">
          ...
          <div class="card-body py-3">
            <div class="filter-bar">
              <div class="search-input">
                ...
                <input type="text" class="form-control" title="Rechercher une catégorie..."
                       [(ngModel)]="recherche" (ngModelChange)="filtrer()">
              </div>
              <span class="text-muted" style="font-size: 0.82rem; white-space: nowrap;">
                {{ categoriesFiltrees.length }} {{ categoriesFiltrees.length !== 1 ? 'résultats' : 'résultat' }}
              </span>
            </div>
          </div>
        </div>
                  ...
                  <tr *ngIf="categoriesFiltrees.length === 0">
                    <td colspan="6" class="text-center">
                      <div class="empty-state">
                        ...
                        <a *ngIf="!recherche" routerLink="/admin/stock/categories/ajouter" class="btn btn-primary btn-sm">
                  ...
                  <tr *ngFor="let categorie of categoriesPage">
                    ...
                    <td class="text-center">
                      <div class="btn-action-group">
                        <a [routerLink]="['/admin/stock/categories/modifier', categorie.id]" class="btn btn-sm btn-warning">
