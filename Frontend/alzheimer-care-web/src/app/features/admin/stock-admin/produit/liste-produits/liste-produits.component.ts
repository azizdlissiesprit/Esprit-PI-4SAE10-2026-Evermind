    ...
    <div class="fade-in">
      <div class="page-header d-flex justify-content-between align-items-center">
        <div>
          ...
          <p class="page-subtitle">{{ produitsFiltres.length }} {{ produitsFiltres.length !== 1 ? 'produits' : 'produit' }} au total</p>
        </div>
        <a routerLink="/admin/stock/produits/ajouter" class="btn btn-primary">
          ...
          <div class="card-body py-3">
            <div class="filter-bar">
              <div class="search-input">
                ...
                <input type="text" class="form-control" title="Rechercher un produit..."
              ...
              <span class="text-muted" style="font-size: 0.82rem; white-space: nowrap;">
                {{ produitsFiltres.length }} {{ produitsFiltres.length !== 1 ? 'résultats' : 'résultat' }}
              </span>
            </div>
          </div>
        </div>
                    ...
                    <td colspan="8" class="text-center">
                      <div class="empty-state">
                        ...
                        <a *ngIf="!recherche && filtreCategorie === 0 && filtreStock === 'tous'"
                           routerLink="/admin/stock/produits/ajouter" class="btn btn-primary btn-sm">
                  ...
                  <tr *ngFor="let produit of produitsPage">
                    ...
                    <td class="text-center">
                      <div class="btn-action-group">
                        <a [routerLink]="['/admin/stock/produits/modifier', produit.id]" class="btn btn-sm btn-warning">
