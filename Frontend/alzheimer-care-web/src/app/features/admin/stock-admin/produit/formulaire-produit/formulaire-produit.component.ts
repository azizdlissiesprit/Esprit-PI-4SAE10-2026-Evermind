              ...
              <form #formulaire="ngForm" (ngSubmit)="sauvegarder()">
                ...
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" id="nom" name="nom"
                         ...
                         #nom="ngModel" title="Ex: Donépézil 10mg"
                ...
                <div class="mb-3">
                  ...
                  <textarea class="form-control" id="description" name="description"
                            ...
                            maxlength="500" title="Décrivez le produit..."></textarea>
                </div>
                ...
                <div class="mb-3">
                  ...
                  <div *ngIf="!previewUrl && (!produit.imageUrl || imageSupprimee)"
                    ...
                    <p class="mb-1 mt-2" style="font-weight: 500;">Cliquez ou glissez une image ici</p>
                    <small class="text-muted">JPEG, PNG, GIF ou WebP — 5 Mo max</small>
                  </div>
                ...
                <div class="d-flex justify-content-between">
                  <a routerLink="/admin/stock/produits" class="btn btn-secondary">
...
export class FormulaireProduitComponent implements OnInit {
  ...
  private traiterFichier(fichier: File): void {
    ...
    if (!typesAcceptes.includes(fichier.type)) {
      this.erreurImage = 'fp.erreurFormat';
      return;
    }
    if (fichier.size > 5 * 1024 * 1024) {
      this.erreurImage = 'fp.erreurTaille';
      return;
    }
  ...
  private gererImageApresSauvegarde(produitId: number): void {
    if (this.fichierSelectionne) {
      this.produitService.uploaderImage(produitId, this.fichierSelectionne).subscribe({
        next: () => this.router.navigate(['/admin/stock/produits']),
        error: () => {
          this.erreur = 'fp.erreurUpload';
          this.enCours = false;
        }
      });
      ...
      this.router.navigate(['/admin/stock/produits']);
    }
  }
}
