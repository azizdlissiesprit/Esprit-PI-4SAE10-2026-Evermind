  ...
  template: `
    <div class="fade-in">
      <div class="page-header d-flex justify-content-between align-items-center">
        <div>
          <h2 class="page-title">
            <i class="bi bi-receipt-cutoff me-2 text-gradient"></i>Gestion des Commandes
          </h2>
          <p class="page-subtitle">{{ commandesFiltrees.length }} {{ commandesFiltrees.length !== 1 ? 'commandes' : 'commande' }} au total</p>
        </div>
      </div>
          ...
          <div class="card-body py-3">
            <div class="filter-bar">
              <div class="search-input">
                ...
                <input type="text" class="form-control" title="Rechercher par référence, client..."
              ...
              <span class="text-muted" style="font-size: 0.82rem; white-space: nowrap;">
                {{ commandesFiltrees.length }} {{ commandesFiltrees.length !== 1 ? 'résultats' : 'résultat' }}
              </span>
            </div>
          </div>
        </div>
          ...
          <div class="card-body p-0">
                ...
                <tbody>
                  ...
                  <tr *ngFor="let cmd of commandesPage">
                    ...
                    <td class="text-center">
                      <a [routerLink]="['/admin/stock/commandes', cmd.id]" class="btn btn-sm btn-primary">
            ...
            <div *ngIf="totalPages > 1" class="pagination-wrapper">
              <div class="pagination-info">
                Affichage {{ debut + 1 }}-{{ fin }} sur {{ commandesFiltrees.length }}
              </div>
